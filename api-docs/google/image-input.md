*   On this page
*   [Passing images to Gemini](#image-input)
    *   [Passing inline image data](#inline-image)
    *   [Uploading images using the File API](#upload-image)
*   [Prompting with multiple images](#multiple-images)
*   [Object detection](#object-detection)
*   [Segmentation](#segmentation)
*   [Supported image formats](#supported-formats)
*   [Capabilities](#capabilities)
*   [Limitations and key technical information](#technical-details-image)
    *   [File limit](#file_limit)
    *   [Token calculation](#token_calculation)
