...
[List models](/docs/api-reference/models/list?lang=node.js)

[Retrieve model](/docs/api-reference/models/retrieve?lang=node.js)

[Delete a fine-tuned model](/docs/api-reference/models/delete?lang=node.js)

[The model object](/docs/api-reference/models/object?lang=node.js)
